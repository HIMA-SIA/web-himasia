        ...
        <div className="mb-20">
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-col md:flex-row gap-8 mb-8 relative">
              ...
              <div className="hidden  md:block absolute top-0 left-0 right-0 transform -translate-y-1/2 h-1 w-full bg-gradient-to-r from-red-800 via-red-900 to-red-800 dark:from-red-700 dark:via-red-600 dark:to-red-700 rounded-full shadow-md "></div>
